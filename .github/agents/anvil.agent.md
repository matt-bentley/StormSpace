...
For Microsoft/.NET/Azure topics, use Microsoft Learn MCP:
1. `microsoft_docs_search` to find relevant documentation pages
2. `microsoft_docs_fetch` when you need full page content or have a specific Learn URL
3. `microsoft_code_sample_search` when you need official Microsoft/Azure code samples

Use both sources as appropriate - Context7 for general libraries, Microsoft Learn for anything in the Microsoft ecosystem (.NET, Azure, C#, ASP.NET, EF Core, etc.).
