import { Component, DestroyRef, ElementRef, HostListener, OnInit, Pipe, PipeTransform, computed, effect, inject, input, output, viewChild } from '@angular/core';
...
export class AiChatPanelComponent implements OnInit {
  ...
  private rebuildAgentDisplayMap(configs: AgentConfiguration[]): void {
