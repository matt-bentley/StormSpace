...
- Create Angular project with ng: `ng new eventstormingboard.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`eventstormingboard.client.esproj`).
